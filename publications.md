...
<img src="../../img/journalArticle.png" height="20px">
"Li, Lei; Dugan, Haley L; Stamper, Christopher; Lan, Linda Yu-Ling; Asby, Nicholas; Knight, Matthew; Stovicek, Olivia; Zheng, Nai-Ying; Madariaga, Maria Lucia; Shanmugarajah, Kumaran; others" *Integration of Transcriptome and Cell Surface Protein Expression by LinQ-View Identifies Unique Immune Subpopulations*  **Pre-print** (2021) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Integration+of+Transcriptome+and+Cell+Surface+Protein+Expression+by+LinQ-View+Identifies+Unique+Immune+Subpopulations)
...
<img src="../../img/journalArticle.png" height="20px">
"Weinstein, Joshua A; Penland, Lolita; Sasaki, Sanae; Dekker, Cornelia L; Wilson, Patrick C; Greenberg, Harry B; Davis, Mark M; Fisher, Daniel S; Quake, Stephen R" *High Throughput Sequencing of the Human Immune Repertoire in Response to Influenza Vaccination*  **The Journal of Immunology** (2011) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=High+Throughput+Sequencing+of+the+Human+Immune+Repertoire+in+Response+to+Influenza+Vaccination)

<img src="../../img/journalArticle.png" height="20px">
"Wrammert, Jens; Koutsonanos, Dimitrios; Li, Gui-Mei; Edupuganti, Srilatha; Sui, Jianhua; Morrissey, Michael; McCausland, Megan; Skountzou, Ioanna; Hornig, Mady; Lipkin, W Ian; others" *"Broadly cross-reactive antibodies dominate the human B cell response against 2009 pandemic H1N1 influenza virus infection (vol 208, pg 181, 2011)"*  **JOURNAL OF EXPERIMENTAL MEDICINE** (2011) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Broadly+cross-reactive+antibodies+dominate+the+human+B+cell+response+against+2009+pandemic+H1N1+influenza+virus+infection+(vol+208,+pg+181,+2011)")

## 2010

<img src="../../img/journalArticle.png" height="20px">
"Mouquet, Hugo; Scheid, Johannes F; Zoller, Markus J; Krogsgaard, Michelle; Ott, Rene G; Shukair, Shetha; Artyomov, Maxim N; Pietzsch, John; Connors, Mark; Pereyra, Florencia; others" *Polyreactivity increases the apparent affinity of anti-HIV antibodies by heteroligation*  **Nature** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Polyreactivity+increases+the+apparent+affinity+of+anti-HIV+antibodies+by+heteroligation)

<img src="../../img/journalArticle.png" height="20px">
"Di Niro, Roberto; Mesin, Luka; Raki, Melinda; Zheng, Nai-Ying; Lund-Johansen, Fridtjof; Lundin, Knut EA; Charpilienne, Annie; Poncet, Didier; Wilson, Patrick C; Sollid, Ludvig M" *Rapid generation of rotavirus-specific human monoclonal antibodies from small-intestinal mucosa*  **The Journal of Immunology** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Rapid+generation+of+rotavirus-specific+human+monoclonal+antibodies+from+small-intestinal+mucosa)

<img src="../../img/journalArticle.png" height="20px">
"Andrews, Sarah F; Wilson, Patrick C" *The anergic B cell*  **"Blood, The Journal of the American Society of Hematology"** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=The+anergic+B+cell)

<img src="../../img/book.png" height="20px">
"Crowe, Sherry; Vineyard, Amanda; Smith, Kenneth; Carla, Guthridge; Morris, Jennifer; Wilson, Patrick; James, Judith" *Generation of fully human monoclonal antibodies following anthrax vaccine absorbed (AVA) vaccination that provide protection from lethal toxin challenge.(52.15)*  **Pre-print** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Generation+of+fully+human+monoclonal+antibodies+following+anthrax+vaccine+absorbed+(AVA)+vaccination+that+provide+protection+from+lethal+toxin+challenge.(52.15))

<img src="../../img/journalArticle.png" height="20px">
"OG, Barr IGMcCauley JCox NDaniels REngelhardt" *"Epidemiological, antigenic and genetic characteristics of seasonal influenza A (H1N1), A (H3N2) and B influenza viruses: basis for the WHO recommendation on the composition of influenza vaccines for use in the 2009-2010 Northern Hemisphere season"*  **Vaccine** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Epidemiological,+antigenic+and+genetic+characteristics+of+seasonal+influenza+A+(H1N1),+A+(H3N2)+and+B+influenza+viruses:+basis+for+the+WHO+recommendation+on+the+composition+of+influenza+vaccines+for+use+in+the+2009-2010+Northern+Hemisphere+season")

<img src="../../img/journalArticle.png" height="20px">
"Neng, Jing; Harpster, Mark H; Zhang, Hao; Mecham, James O; Wilson, William C; Johnson, Patrick A" *A versatile SERS-based immunoassay for immunoglobulin detection using antigen-coated gold nanoparticles and malachite green-conjugated protein A/G*  **Biosensors and Bioelectronics** (2010) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=A+versatile+SERS-based+immunoassay+for+immunoglobulin+detection+using+antigen-coated+gold+nanoparticles+and+malachite+green-conjugated+protein+A/G)

## 2009

<img src="../../img/journalArticle.png" height="20px">
"Smith, Kenneth; Garman, Lori; Wrammert, Jens; Zheng, Nai-Ying; Capra, J Donald; Ahmed, Rafi; Wilson, Patrick C" *Rapid generation of fully human monoclonal antibodies specific to a vaccinating antigen*  **Nature protocols** (2009) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Rapid+generation+of+fully+human+monoclonal+antibodies+specific+to+a+vaccinating+antigen)

<img src="../../img/journalArticle.png" height="20px">
"Duty, J Andrew; Szodoray, Peter; Zheng, Nai-Ying; Koelsch, Kristi A; Zhang, Qingzhao; Swiatkowski, Mike; Mathias, Melissa; Garman, Lori; Helms, Christina; Nakken, Britt; others" *Functional anergy in a subpopulation of naive B cells from healthy humans that express autoreactive immunoglobulin receptors*  **Journal of Experimental Medicine** (2009) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Functional+anergy+in+a+subpopulation+of+naive+B+cells+from+healthy+humans+that+express+autoreactive+immunoglobulin+receptors)

<img src="../../img/journalArticle.png" height="20px">
"Illes, A; Varoczy, L; Papp, G; Wilson, PC; Alex, P; Jonsson, R; Kovacs, T; Konttinen, Yrjö T; Zeher, M; Nakken, B; others" *Aspects of B-Cell Non-Hodgkin’s Lymphoma Development: A Transition from Immune-Reactivity to Malignancy*  **Scandinavian journal of immunology** (2009) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Aspects+of+B-Cell+Non-Hodgkin’s+Lymphoma+Development:+A+Transition+from+Immune-Reactivity+to+Malignancy)

<img src="../../img/journalArticle.png" height="20px">
"AshokKumar, Chethan; Talukdar, Anjan; Sun, Qing; Higgs, Brandon W; Janosky, Janine; Wilson, Patrick; Mazariegos, George; Jaffe, Ronald; Demetris, Anthony; Dobberstein, Jennifer; others" *Allospecific CD154+ T cells associate with rejection risk after pediatric liver transplantation*  **American Journal of Transplantation** (2009) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Allospecific+CD154++T+cells+associate+with+rejection+risk+after+pediatric+liver+transplantation)

## 2008

<img src="../../img/journalArticle.png" height="20px">
"Wrammert, Jens; Smith, Kenneth; Miller, Joe; Langley, William A; Kokko, Kenneth; Larsen, Christian; Zheng, Nai-Ying; Mays, Israel; Garman, Lori; Helms, Christina; others" *Rapid cloning of high-affinity human monoclonal antibodies against influenza virus*  **Nature** (2008) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Rapid+cloning+of+high-affinity+human+monoclonal+antibodies+against+influenza+virus)

<img src="../../img/journalArticle.png" height="20px">
"Jackson, Stephen M; Wilson, Patrick C; James, Judith A; Capra, J Donald" *Human B cell subsets*  **Advances in immunology** (2008) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Human+B+cell+subsets)

## 2007

<img src="../../img/journalArticle.png" height="20px">
"Crouch, Elizabeth E; Li, Zhiyu; Takizawa, Makiko; Fichtner-Feigl, Stefan; Gourzi, Polyxeni; Montaño, Carolina; Feigenbaum, Lionel; Wilson, Patrick; Janz, Siegfried; Papavasiliou, F Nina; others" *Regulation of AID expression in the immune response*  **The Journal of experimental medicine** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Regulation+of+AID+expression+in+the+immune+response)

<img src="../../img/journalArticle.png" height="20px">
"Koelsch, Kristi; Zheng, Nai-Ying; Zhang, Qingzhao; Duty, Andrew; Helms, Christina; Mathias, Melissa D; Jared, Mathew; Smith, Kenneth; Capra, J Donald; Wilson, Patrick C" *Mature B cells class switched to IgD are autoreactive in healthy individuals*  **The Journal of clinical investigation** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Mature+B+cells+class+switched+to+IgD+are+autoreactive+in+healthy+individuals)

<img src="../../img/journalArticle.png" height="20px">
"Casellas, Rafael; Zhang, Qingzhao; Zheng, Nai-Ying; Mathias, Melissa D; Smith, Kenneth; Wilson, Patrick C" *Igκ allelic inclusion is a consequence of receptor editing*  **The Journal of experimental medicine** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Igκ+allelic+inclusion+is+a+consequence+of+receptor+editing)

<img src="../../img/journalArticle.png" height="20px">
"Gaëta, Bruno A; Malming, Harald R; Jackson, Katherine JL; Bain, Michael E; Wilson, Patrick; Collins, Andrew M" *iHMMune-align: hidden Markov model-based alignment and identification of germline genes in rearranged immunoglobulin gene sequences*  **Bioinformatics** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=iHMMune-align:+hidden+Markov+model-based+alignment+and+identification+of+germline+genes+in+rearranged+immunoglobulin+gene+sequences)

<img src="../../img/journalArticle.png" height="20px">
"Teague, Brittany N; Pan, Yujun; Mudd, Philip A; Nakken, Britt; Zhang, Qingzhao; Szodoray, Peter; Kim-Howard, Xana; Wilson, Patrick C; Farris, A Darise" *"Cutting edge: Transitional T3 B cells do not give rise to mature B cells, have undergone selection, and are reduced in murine lupus"*  **The Journal of Immunology** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Cutting+edge:+Transitional+T3+B+cells+do+not+give+rise+to+mature+B+cells,+have+undergone+selection,+and+are+reduced+in+murine+lupus")

<img src="../../img/book.png" height="20px">
"Koelsch, Kristi A; Zheng, Nai-Ying; Zhang, Qingzhao; Duty, Andrew; Abraham, Leni A; Helms, Christina; Mathias, Melissa D; Jared, Mathew; Smith, Kenneth; Wilson, Patrick C" *Mature B cells from healthy people which are permanently class switched to the IgD isotype are autoreactive (B95)*  **Pre-print** (2007) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Mature+B+cells+from+healthy+people+which+are+permanently+class+switched+to+the+IgD+isotype+are+autoreactive+(B95))

## 2006

<img src="../../img/journalArticle.png" height="20px">
"Kolar, GR; Mehta, D; Wilson, PC; Capra, JD" *Diversity of the Ig repertoire is maintained with age in spite of reduced germinal centre cells in human tonsil lymphoid tissue*  **Scandinavian journal of immunology** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Diversity+of+the+Ig+repertoire+is+maintained+with+age+in+spite+of+reduced+germinal+centre+cells+in+human+tonsil+lymphoid+tissue)

<img src="../../img/journalArticle.png" height="20px">
"Szodoray, Peter; Alex, P; Frank, MB; Turner, M; Turner, S; Knowlton, N; Cadwell, C; Dozmorov, I; Tang, Y; Wilson, PC; others" *A genome-scale assessment of peripheral blood B-cell molecular homeostasis in patients with rheumatoid arthritis*  **Rheumatology** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=A+genome-scale+assessment+of+peripheral+blood+B-cell+molecular+homeostasis+in+patients+with+rheumatoid+arthritis)

<img src="../../img/conferencePaper.png" height="20px">
"Teague, Brittany N; Nakken, Britt; Mudd, Philip A; Zhang, Qingzhao; Kim-Howard, Xana; Wilson, Patrick C; Farris, Darise" *"Transitional T3 B cells do not give rise to mature B cells, have undergone selection, and are reduced in murine lupus."*  **ARTHRITIS AND RHEUMATISM** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Transitional+T3+B+cells+do+not+give+rise+to+mature+B+cells,+have+undergone+selection,+and+are+reduced+in+murine+lupus.")

<img src="../../img/conferencePaper.png" height="20px">
"Duty, J Andrew; Szodoray, Peter; Zheng, Nai-Ying; Jared, Matthew; Wilson, Kenneth; Wilson, Patrick C" *Analysis of a new autoreactive B cell population in human peripheral blood*  **JOURNAL OF IMMUNOLOGY** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Analysis+of+a+new+autoreactive+B+cell+population+in+human+peripheral+blood)

<img src="../../img/journalArticle.png" height="20px">
"Ooms, Theodora; Boggess, Jacqueline; Menard, Anne; Myrick, Mary; Roberts, Paula; Tweedie, Jack; Wilson, Pamela" *"Building bridges between healthy marriage, responsible fatherhood, and domestic violence programs"*  **"Washington, DC: Center for Law and Social Policy"** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Building+bridges+between+healthy+marriage,+responsible+fatherhood,+and+domestic+violence+programs")

<img src="../../img/journalArticle.png" height="20px">
"Willis, L; Flinn, D; Hynd, RF; Carson, C; Kumar, A; El-Gabalawy, HS; Centola, M; Dozmorov, I; Tang, Y; Wilson, PC; others" *PMC415561.*  **arthritis. Rheumatology (Oxford)** (2006) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=PMC415561.)

## 2005

<img src="../../img/journalArticle.png" height="20px">
"Zheng, Nai-Ying; Wilson, Kenneth; Jared, Matthew; Wilson, Patrick C" *Intricate targeting of immunoglobulin somatic hypermutation maximizes the efficiency of affinity maturation*  **The Journal of experimental medicine** (2005) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Intricate+targeting+of+immunoglobulin+somatic+hypermutation+maximizes+the+efficiency+of+affinity+maturation)

## 2004

<img src="../../img/journalArticle.png" height="20px">
"Meffre, Eric; Schaefer, Anne; Wardemann, Hedda; Wilson, Patrick; Davis, Eric; Nussenzweig, Michel C" *Surrogate light chain expressing human peripheral B cells produce self-reactive antibodies*  **The Journal of experimental medicine** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Surrogate+light+chain+expressing+human+peripheral+B+cells+produce+self-reactive+antibodies)

<img src="../../img/journalArticle.png" height="20px">
"Zheng, Nai-Ying; Wilson, Kenneth; Wang, Xiaojian; Boston, Angela; Kolar, Grant; Jackson, Stephen M; Liu, Yong-Jun; Pascual, Virginia; Capra, J Donald; Wilson, Patrick C" *Human immunoglobulin selection associated with class switch and possible tolerogenic origins for Cδ class-switched B cells*  **The Journal of clinical investigation** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Human+immunoglobulin+selection+associated+with+class+switch+and+possible+tolerogenic+origins+for+Cδ+class-switched+B+cells)

<img src="../../img/journalArticle.png" height="20px">
"Szodoray, P; Alex, P; Dandapani, V; Nakken, B; Pesina, J; Kim, X; Wallis, GL; Wilson, PC; Jonsson, R; Centola, M" *Apoptotic effect of rituximab on peripheral blood B cells in rheumatoid arthritis*  **Scandinavian journal of immunology** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Apoptotic+effect+of+rituximab+on+peripheral+blood+B+cells+in+rheumatoid+arthritis)

<img src="../../img/journalArticle.png" height="20px">
"Szodoray, Peter; Jellestad, Stig; Alex, Philip; Zhou, Tong; Wilson, Patrick C; Centola, Michael; Brun, Johan G; Jonsson, Roland" *Programmed cell death of peripheral blood B cells determined by laser scanning cytometry in Sjögren’s syndrome with a special emphasis on BAFF*  **Journal of clinical immunology** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Programmed+cell+death+of+peripheral+blood+B+cells+determined+by+laser+scanning+cytometry+in+Sjögren’s+syndrome+with+a+special+emphasis+on+BAFF)

<img src="../../img/conferencePaper.png" height="20px">
"Kolar, GR; Wilson, PC; Capra, JD" *Human tonsillar B cells undergo dramatic phenotypic changes with age*  **FASEB JOURNAL** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Human+tonsillar+B+cells+undergo+dramatic+phenotypic+changes+with+age)

<img src="../../img/conferencePaper.png" height="20px">
"Zheng, NY; Wilson, K; Capra, JD; Wilson, PC" *Immunoglobulin V gene evolution is primarily to maximize activation-induced cytodine deaminase activity*  **FASEB JOURNAL** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Immunoglobulin+V+gene+evolution+is+primarily+to+maximize+activation-induced+cytodine+deaminase+activity)

<img src="../../img/conferencePaper.png" height="20px">
"Teague, BN; Nakken, B; Mudd, PA; King-Howard, X; Wilson, PC; Farris, AD" *Perturbations in B cell populations of autoimmune prone mice suggest altered anergic B cell compartment in NZB/NZW related strains.*  **ARTHRITIS AND RHEUMATISM** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Perturbations+in+B+cell+populations+of+autoimmune+prone+mice+suggest+altered+anergic+B+cell+compartment+in+NZB/NZW+related+strains.)

<img src="../../img/conferencePaper.png" height="20px">
"Chang, SH; Liang, ZY; Hsu, K; Wilson, P; Mohan, C" *"Origins of antinuclear antibodies-genetically programmed selection of antibodies with germline-encoded, NoN-anionic heavy chain CDRs into the primary immunoglobulin repertoire."*  **ARTHRITIS AND RHEUMATISM** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q="Origins+of+antinuclear+antibodies-genetically+programmed+selection+of+antibodies+with+germline-encoded,+NoN-anionic+heavy+chain+CDRs+into+the+primary+immunoglobulin+repertoire.")

<img src="../../img/conferencePaper.png" height="20px">
"Wilson, PC; Wilson, K; Zheng, NY; Wang, XJ; Boston, A; Kolar, GR; Jackson, SM; Liu, YJ; Pascual, V; Capra, JD" *Class switch is inhibited for autoreactive human B cells*  **FASEB JOURNAL** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Class+switch+is+inhibited+for+autoreactive+human+B+cells)

<img src="../../img/journalArticle.png" height="20px">
"Ooms, Theodora; Wilson, Pamela" *The challenges of offering relationship and marriage education to low-income populations*  **Family Relations** (2004) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=The+challenges+of+offering+relationship+and+marriage+education+to+low-income+populations)

## 2003

<img src="../../img/conferencePaper.png" height="20px">
"Szodoray, P; Frank, MB; Tang, YH; Nakken, B; Turner, S; Cadwell, C; Dozmorov, I; Wilson, PC; Jonsson, R; Centola, M" *Gene expression profile of peripheral blood B cells in rheumatoid arthritis.*  **ARTHRITIS AND RHEUMATISM** (2003) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Gene+expression+profile+of+peripheral+blood+B+cells+in+rheumatoid+arthritis.)

<img src="../../img/conferencePaper.png" height="20px">
"Wilson, PC; Wang, XJ; Wilson, K; Zheng, NY; Banchereau, J; Pascual, V; Capra, JD" *Trace autoreactivity in naive (unmutated) B cells produces tolerant phenotypes in Ig transgenic mice*  **FASEB JOURNAL** (2003) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Trace+autoreactivity+in+naive+(unmutated)+B+cells+produces+tolerant+phenotypes+in+Ig+transgenic+mice)

<img src="../../img/conferencePaper.png" height="20px">
"Wilson, PC; Wang, XJ; Wilson, K; Zheng, NY; Banchereau, J; Pascual, V; Capra, JD" *Class switch recombination is directly inhibited at the secondary isotype switch recombination signal sequences in autoreactive B cells*  **FASEB JOURNAL** (2003) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Class+switch+recombination+is+directly+inhibited+at+the+secondary+isotype+switch+recombination+signal+sequences+in+autoreactive+B+cells)

<img src="../../img/conferencePaper.png" height="20px">
"Szodoray, P; Alex, P; Nakken, B; Wilson, PC; Jonsson, R; Centola, M" *Apoptotic effect of rituximab on B cells in rheumatoid arthritis.*  **ARTHRITIS AND RHEUMATISM** (2003) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Apoptotic+effect+of+rituximab+on+B+cells+in+rheumatoid+arthritis.)

## 2002

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick; Capra, J Donald" *Receptor revision is a common mechanism of anti-body diversification in human B cells*  **Human Antibodies** (2002) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Receptor+revision+is+a+common+mechanism+of+anti-body+diversification+in+human+B+cells)

## 2001

<img src="../../img/journalArticle.png" height="20px">
"Petersen, Simone; Casellas, Rafael; Reina-San-Martin, Bernardo; Chen, Hua Tang; Difilippantonio, Michael J; Wilson, Patrick C; Hanitsch, Leif; Celeste, Arkady; Muramatsu, Masamichi; Pilch, Duane R; others" *AID is required to initiate Nbs1/γ-H2AX focus formation and mutations at sites of class switching*  **Nature** (2001) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=AID+is+required+to+initiate+Nbs1/γ-H2AX+focus+formation+and+mutations+at+sites+of+class+switching)

<img src="../../img/journalArticle.png" height="20px">
"Yannoutsos, Nikos; Wilson, Patrick; Yu, Wong; Chen, Hua Tang; Nussenzweig, Andre; Petrie, Howard; Nussenzweig, Michel C" *The role of recombination activating gene (RAG) reinduction in thymocyte development in vivo*  **The Journal of experimental medicine** (2001) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=The+role+of+recombination+activating+gene+(RAG)+reinduction+in+thymocyte+development+in+vivo)

<img src="../../img/journalArticle.png" height="20px">
"Rossi, Maria Isabel D; Medina, Kay L; Garrett, Karla; Kolar, Grant; Shultz, Leonard D; Capra, J Donald; Wilson, Patrick; Schipul, Arthur; Kincade, Paul W; others" *Relatively normal human lymphopoiesis but rapid turnover of newly formed B cells in transplanted nonobese diabetic/SCID mice*  **The Journal of Immunology** (2001) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Relatively+normal+human+lymphopoiesis+but+rapid+turnover+of+newly+formed+B+cells+in+transplanted+nonobese+diabetic/SCID+mice)

<img src="../../img/journalArticle.png" height="20px">
"Rossi, Maria Isabel D; Medina, Kay L; Garrett, Karla; Kolar, Grant; Comp, Phillip C; Shultz, Leonard D; Capra, J Donald; Wilson, Patrick; Schipul, Arthur; Kincade, Paul W" *CELLULAR IMMUNOLOGY AND IMMUNE REGULATION-Relatively Normal Human Lymphopoiesis but Rapid Turnover of Newly Formed B Cells in Transplanted Nonobese Diabetic/SCID Mice*  **Journal of Immunology** (2001) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=CELLULAR+IMMUNOLOGY+AND+IMMUNE+REGULATION-Relatively+Normal+Human+Lymphopoiesis+but+Rapid+Turnover+of+Newly+Formed+B+Cells+in+Transplanted+Nonobese+Diabetic/SCID+Mice)

<img src="../../img/journalArticle.png" height="20px">
"Shultz, Leonard D; Capra, J Donald; Wilson, Patrick; Schipul, Arthur; Kincade, Paul W" *Relatively Normal Human Lymphopoiesis but Rapid Turnover of Newly Formed B Cells in Transplanted Nonobese Diabetic/SCID Mice*  **Pre-print** (2001) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Relatively+Normal+Human+Lymphopoiesis+but+Rapid+Turnover+of+Newly+Formed+B+Cells+in+Transplanted+Nonobese+Diabetic/SCID+Mice)

## 2000

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick C; Wilson, Kenneth; Liu, Yong-Jun; Banchereau, Jacques; Pascual, Virginia; Capra, J Donald" *Receptor revision of immunoglobulin heavy chain variable region genes in normal human B lymphocytes*  **The Journal of experimental medicine** (2000) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Receptor+revision+of+immunoglobulin+heavy+chain+variable+region+genes+in+normal+human+B+lymphocytes)

<img src="../../img/conferencePaper.png" height="20px">
"Wilson, PC; Wilson, K; Liu, YJ; Banchereau, J; Pascual, V; Capra, JD" *Secondary V (D) J recombination of immunoglobulin VH genes from human tonsil B lymphocytes*  **FASEB JOURNAL** (2000) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Secondary+V+(D)+J+recombination+of+immunoglobulin+VH+genes+from+human+tonsil+B+lymphocytes)

<img src="../../img/thesis.png" height="20px">
"Wilson, Patrick Christopher" *Immunglobulin VH gene diversification in mature B lymphocyte subpopulations*  **Pre-print** (2000) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Immunglobulin+VH+gene+diversification+in+mature+B+lymphocyte+subpopulations)

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Mr James E; Wilson, Dear Mr" *SALEM*  **Pre-print** (2000) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=SALEM)

## 1998

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick C; Bouteiller, Odette de; Liu, Yong-Jun; Potter, Kathleen; Banchereau, Jacques; Capra, J Donald; Pascual, Virginia" *Somatic hypermutation introduces insertions and deletions into immunoglobulin V genes*  **The Journal of experimental medicine** (1998) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Somatic+hypermutation+introduces+insertions+and+deletions+into+immunoglobulin+V+genes)

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick; Liu, Yong-Jun; Bonchereau, Jacques; Capra, J Donald; Pascual, Virginia" *Amino acid insertions and deletions contribute to diversify the human Ig repertoire*  **Immunological reviews** (1998) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Amino+acid+insertions+and+deletions+contribute+to+diversify+the+human+Ig+repertoire)

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick C; Donald Capra, J" *The super-information age of immunoglobulin genetics*  **The Journal of experimental medicine** (1998) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=The+super-information+age+of+immunoglobulin+genetics)

<img src="../../img/journalArticle.png" height="20px">
"Wilson, PC; Capra, JD" *The insertion/deletion phenotype in somatic hypermutation and a new model for somatic hypermutation*  **IMMUNOLOGIST** (1998) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=The+insertion/deletion+phenotype+in+somatic+hypermutation+and+a+new+model+for+somatic+hypermutation)

## 1997

<img src="../../img/journalArticle.png" height="20px">
"Pascual, Virginia; Wilson, Patrick; Liu, Yong-Jun; Banchereau, J; Capra, J Donald" *Biased VH4 gene segment repertoire in the human tonsil*  **Human B Cell Populations** (1997) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Biased+VH4+gene+segment+repertoire+in+the+human+tonsil)

<img src="../../img/journalArticle.png" height="20px">
"Wilson, Patrick; Liu, Y-J; de Bouteiller, O; Banchereau, J; Capra, J; Pascual, V" *An Analysis of Codon Length Insertions and Deletions in the CDR Regions of VHGenes of Human Tonsillar B cells: Insights into Mechanisms of Somatic Hypermutation*  **The Journal of Allergy and Clinical Immunology** (1997) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=An+Analysis+of+Codon+Length+Insertions+and+Deletions+in+the+CDR+Regions+of+VHGenes+of+Human+Tonsillar+B+cells:+Insights+into+Mechanisms+of+Somatic+Hypermutation)

<img src="../../img/journalArticle.png" height="20px">
"Roy, Ronald R; Wilson, Patrick; Laski, Ronald R; Roberts, James I; Weishaar, Joseph A; Bong, Rodney L; Yess, Norma J" *Monitoring of domestic and imported apples and rice by the US Food and Drug Administration pesticide program*  **Journal of AOAC International** (1997) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Monitoring+of+domestic+and+imported+apples+and+rice+by+the+US+Food+and+Drug+Administration+pesticide+program)

## 1996

<img src="../../img/conferencePaper.png" height="20px">
"Wilson, P; Liu, YJ; Banchereau, J; Capra, JD; Pascual, V" *Novel mechanisms of diversification of the human Ig repertoire within peripheral lymphoid organs.*  **ARTHRITIS AND RHEUMATISM** (1996) [Google Scholar](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C14&q=Novel+mechanisms+of+diversification+of+the+human+Ig+repertoire+within+peripheral+lymphoid+organs.)
